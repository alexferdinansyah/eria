            ...
            <div class="d-flex justify-content-center align-items-center pb-4">
                ...
                <div class="contain d-flex flex-col">
                    ...
                    <div class="pub-content">
                        ...
                        <a href="/publications/details/1" class="btn btn-outline-light" style="font-size: 14px;">Read More</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="sec-pub">
    ...
    <section class="card-par">
        <div class="card-child col" style="padding: 5px 10px;">
        ...
        <div class="card-child col" style="padding: 10px 10px;">
