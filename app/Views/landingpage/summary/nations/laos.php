...
<header class="header-program">
    <div class="flex-column">
        <div class="show-on-mobile pb-4 m-0 flex align-items-center gap-2">
          <img style="width:60px;" src="<?= base_url('assets/images/nations/flags/laos.svg'); ?>" alt="">    
          <p class="mb-0">Laos</p>
        </div>
        <div class="hidden-on-mobile pb-4 m-0 flex align-items-center gap-2">
          <img style="width:120px;" src="<?= base_url('assets/images/nations/flags/laos.svg'); ?>" alt="">    
          <h2 class="mb-0">Laos</h2>
        </div>
        <div class="d-flex flex-row gap-1 align-items-start">
            ...
            <a class="bg-white text-decoration-none border-white <?= $cat == 'forcasting' ? 'pb-1' : '' ?>" href="<?= base_url('summarymobile/forcasting/laos') ?>">
        ...
        <?php if($cat == 'econometric'): ?>   
              <!-- econometric start -->
                  <div class="row row-cols-1 row-cols-md-2 justify-content-evenly mb-4">
                      ...
                      <img class="img-map" src="<?= base_url('assets/images/nations/maps/laos.svg') ?>" alt="">
