...
<div class="container pd d-flex justify-content-center align-items-center">
    <section class="pd-content">
        <h2>Policy Recommendation to Achieve a Carbon-Neutral Economy: The Case of Corporate Governance and Carbon Performance in Malaysia’s Smart Cities </h1>
        <div class="pd-one">
                ...
                <div class="pd-two">
                    ...
                    <p>11 Juli 2024</p>
                    <p>Author:</p>
                    <p>Siti Indati Mustapa, Noor Raida Abd Rahman, Amar Hisham Jaaffar, Nor Salwati Othman, Syarifah Mardhiah Syed Salim
                    </p>
                    <p>Tags:</p>
