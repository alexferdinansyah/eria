                ...
                <div class="modal-body">
                    <form action="<?= base_url('search') ?>" method="get">
                        <div class="input-group">
                            <input type="text" class="form-control search-input" id="searchQuery" name="query"
                                placeholder="Search...">
            ...
            <div class="row mb-3">
                <div class="col-lg-8">
                    <div class="custom-footer-content">
                        ...
                        <p>An online data of ASEAN new & alternative vehicle technology with the main objective of
                            providing comprehensive
                            information on the current situation of alternative vehicle technology development in 10
                            ASEAN member states
                            to open public and to regularly produce ASEAN Vehicle Technology Outlook</p>
                        <hr class="custom-divider">
                        <p class="copy" style="margin-bottom: 20px; margin-top: -20px;">Copyrights © 2023 ERIA. All
                            rights reserved.</p>
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="logo-container d-flex align-items-center justify-content-lg-end">
                                    <div class="logo d-flex align-items-center mb-3">
                                        <a href="#" class="d-block" aria-label="Home - European Commission">
                                            <img src="<?= base_url('assets/images/logo-eria-white.png') ?>"
                                                alt="Logo ERIA" class="img-fluid custom-logo">
                                        </a>
                                        <div class="logo-description">
                                            <a href="https://www.eria.org" target="_blank">ERIA</a>
                                            <p>This represents the Economic Research Institute for ASEAN and East
                                                Asia.</p>
                                        </div>
                                    ...
                                    <div class="logo d-flex align-items-center">
                                        <a href="#" class="d-block" aria-label="Home - European Commission">
                                            <img src="<?= base_url('assets/images/logoui.png') ?>" alt="Logo UI"
                                                class="img-fluid custom-logo">
                                        </a>
                                        <div class="logo-description">
                                            <a href="https://www.ui.ac.id" target="_blank">Universitas Indonesia</a>
                                            <p>This represents the University of Indonesia, a partner institution.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
